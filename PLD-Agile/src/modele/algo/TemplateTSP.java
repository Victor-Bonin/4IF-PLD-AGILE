...
public abstract class TemplateTSP implements TSP {
	 ...
	 */
	protected abstract int bound(Integer sommetCourant, ArrayList<Integer> nonVus, int heureActuelle, int[][] cout, int[] duree, int[][] horaires);
	 ...
	 */
	protected abstract Iterator<Integer> iterator(Integer sommetCrt, ArrayList<Integer> nonVus, int heureActuelle, int[][] cout, int[] duree, int[][] horaires);
	 ...
	 */	
	 void branchAndBound(int sommetCrt, ArrayList<Integer> nonVus, ArrayList<Integer> vus, int coutVus, int heureDebut, int[][] cout, int[] duree, int[][] horaires, long tpsDebut, int tpsLimite){
		 compteur++;
		 ...
		 } else if (coutVus + bound < coutMeilleureSolution && bound != Integer.MAX_VALUE){
	        Iterator<Integer> it = iterator(sommetCrt, nonVus, heureDebut + coutVus, cout, duree, horaires);
	        while (it.hasNext()){
