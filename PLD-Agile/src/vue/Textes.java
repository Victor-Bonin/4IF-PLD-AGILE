...
public interface Textes {
	...
	public static final String NOTIF_TOURNEE_CALCULE = "Vous pouvez maintenant éditer votre tournée\nUne tournée a été calculée, vous pouvez exporter la feuille de route";
